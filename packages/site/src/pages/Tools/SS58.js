...
export default function SS58() {
    ...
    return (
        mobile ? <div style={{display: 'flex', justifyContent: 'center',flexWrap:'wrap'}}>
                    <div>
                    ...
                    <div style={{
                        ...
                        <div style={{marginTop: '20px'}}>
                            <div style={{position: 'absolute', marginTop: '50px', marginLeft: '40px'}}>
                                ...
                                <TextArea value={searchValue} onChange={handleSearchValue} rows={2} style={{
                                    marginTop: '15px',
                                    width: '320px',
                                    height: '74px',
                                    resize: 'none',
                                ...
                                {notFound ? <div
                                    style={{color: 'red', fontSize: '12px', marginTop: '10px'}}>转换失败，未找到此账号或公钥</div> : null}
                                <Button onClick={handleTransform} block style={{
                                    marginTop: '220px',
                                    width: '320px',
                                    height: '40px',
                                    background: '#3f3f3f',
                ...
                <div>
                    <MyIcon type="icon-Rightxiangyou32"
                    ...
                    <div style={{
                        ...
                        {show ? <ul style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center', fontSize: '12px'}}>
                            ...
                            <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%'}}>
                                <img src={search} style={{width: '290px'}}/></div>}
                    </div>
                </div>
            </div> :
            <div style={{display: 'flex', justifyContent: 'center'}}>
                ...
                <div>
                    <MyIcon type="icon-Rightxiangyou32"
                            style={{marginTop: '320px', marginLeft: '30px', marginRight: '30px'}}/>
                </div>
                <div>
                    <div style={{
                        width: '700px',
                        ...
                        {show ?
                            <ul style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center', fontSize: '12px'}}>
                                <li style={{
                                    width: '566px',
                                    height: '90px',
                                    background: '#f8f9fa',
