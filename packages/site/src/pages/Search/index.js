...
import {
    eventSearchSelector, extrinsicSearchSelector,
    fetchEventSearch, fetchExtrinsicSearch,
    NodeblockSelector
    ...
    return (
        <div>
            <div>
                ...
                <Select defaultValue="event" style={{ width: 400, marginBottom: 20 }} onChange={handleChange}>
